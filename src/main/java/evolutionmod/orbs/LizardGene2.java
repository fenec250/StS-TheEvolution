...
public class LizardGene2 extends AbstractGene {
	public static final String ID = "evolutionmod:LizardGene2";
	public static final OrbStrings orbStrings = CardCrawlGame.languagePack.getOrbString(ID);
	public static final String NAME = orbStrings.NAME;
	public static final String COLOR_STRING = "[#80E081]";
...
//		super.updateDescription();
	...
	private static int damage() {
		int damage = DAMAGE
				+ SalamanderPower.getLizardDamage()
	...
	public static class Adaptation extends AdaptableEvoCard.AbstractAdaptation {
		...
		public void apply(AbstractPlayer p, AbstractMonster m) {
			LizardGene2.apply(p, m, this.amount, true);
		}
