...
public class SubmissionPower extends AbstractPower {
    public static final String POWER_ID = "evolutionmod:SubmissionPower";
    public static final PowerStrings cardStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = cardStrings.NAME;
    public static final String[] DESCRIPTIONS = cardStrings.DESCRIPTIONS;

    public SubmissionPower(AbstractCreature owner, int initialAmount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//            damage += this.amount;
    ...
    public float atDamageReceive(float damage, DamageInfo.DamageType damageType) {
        ...
        return super.atDamageReceive(damage += this.amount, damageType);
    }
}
