...
public class LoseThornsPower extends AbstractPower {
    public static final String POWER_ID = "evolutionmod:LoseThornsPower";
    ...
    public LoseThornsPower(AbstractCreature owner, int initialAmount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//                if (this.owner.getPower(ThornsPower.POWER_ID).amount <= this.decay && !this.owner.hasPower(ArtifactPower.POWER_ID)) {
...
//                } else {
                    AbstractDungeon.actionManager.addToBottom(
                            new ApplyPowerAction(this.owner, this.owner, new ThornsPower(this.owner, -this.decay), -this.decay));
//                }
            }
            AbstractDungeon.actionManager.addToBottom(
                    new ApplyPowerAction(this.owner, this.owner, new LoseThornsPower(this.owner, -this.decay), -this.decay));
            this.decay = 0;
        }
    }
