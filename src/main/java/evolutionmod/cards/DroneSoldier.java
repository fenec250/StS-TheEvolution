...
public class DroneSoldier
        extends BaseEvoCard {
    public static final String ID = "evolutionmod:DroneSoldier";
    ...
    public static DroneSoldier createDroneWithInteractions(AbstractPlayer player) {
        return new DroneSoldier();
    }
