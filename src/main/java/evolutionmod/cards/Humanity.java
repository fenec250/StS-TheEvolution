...
import evolutionmod.powers.HumanityPower;

import java.util.stream.Collectors;

public class Humanity extends BaseEvoCard {
    public static final String ID = "evolutionmod:Humanity";
...
//    private static final int UPGRADE_OMNI_AMT = 1;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new HumanityPower(p, this.magicNumber)));
    }
