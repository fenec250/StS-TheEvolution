...
public class PlayingRough
        extends BaseEvoCard {
    public static final String ID = "evolutionmodV2:PlayingRough";
...
//    public static final String IMG_PATH = "evolutionmod/images/cards/Nightmare.png";
	...
	private void alterDamageAround(Runnable supercall) {
		this.baseDamage = DAMAGE_AMT + (upgraded ? UPGRADE_DAMAGE_AMT:0) + (isPlayerInThisForm(SuccubusGene2.ID) ? this.magicNumber : 0);
		supercall.run();
